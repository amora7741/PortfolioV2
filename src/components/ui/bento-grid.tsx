...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        'cursor-pointer row-span-1 rounded-3xl group/bento hover:bg-neutral-100/50 dark:hover:bg-neutral-900/50 transition duration-200 shadow-input dark:shadow-none p-2 sm:p-6  bg-transparentjustify-between flex flex-col space-y-4',
        className
      )}
    >
