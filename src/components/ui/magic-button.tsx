const MagicButton = ({
  ...
  return (
    ...
    >
      ...
      <span className='inline-flex h-full w-full cursor-pointer items-center justify-center rounded-md bg-neutral-50 dark:bg-neutral-900 px-12 py-1 text-xs font-semibold backdrop-blur-3xl gap-2'>
        {text}
        {icon}
      </span>
    </button>
